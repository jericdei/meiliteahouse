    ...
    <div class="w-full">
      ...
      <p class="italic font-bold">
        {{
          submission.occupation.data[
            submission.occupation.type === 'Student' ? 'courseYear' : 'position'
          ]
        }}
      ...
      <div class="grid grid-cols-2 mt-5">
        <div>
          ...
          <p><span class="font-bold">Email: </span>{{ submission.email }}</p>

          <p>
            <span class="font-bold">Age: </span>{{ submission.age }} years old
          </p>
