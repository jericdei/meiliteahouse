...
<template>
  <div class="p-5">
    ...
    <form @submit.prevent="submit()" enctype="multipart/form-data">
      <div class="p-3 mx-5 bg-slate-200 md:p-10 rounded-xl md:mx-10 lg:mx-20">
        <div>
          ...
          <div class="form-grid-3">
            ...
            <span class="w-full p-float-label">
              ...
              />
              <label class="w-full" for="middleName">Middle Name</label>
            </span>
          ...
          >
            <span class="w-full px-1 p-float-label">
              ...
              />
              <label class="w-full" for="referralCode">Referral Code</label>
            </span>
          ...
          <div>
            ...
            <div class="mt-10 p-float-label">
              ...
              <label for="occupationType"
                >Occupation Type <span class="text-danger">*</span></label
              >
            </div>
          </div>
            ...
            <div class="flex flex-col gap-8">
              <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                <span class="w-full p-float-label">
                  ...
                  />
                  <label class="w-full" for="occupationData.name"
                    >{{ occupation }} Name
                ...
                <span class="w-full p-float-label">
                  ...
                  />
                  <label class="w-full" for="occupationData.contactNo"
              ...
              <span class="w-full p-float-label">
                ...
                />
                <label class="w-full" for="occupationData.address"
                  >{{ occupation }} Address
                  <span class="text-danger">*</span></label
                >
              </span>
              ...
              >
                ...
                />
                <label class="w-full" for="occupationData.courseYear"
              ...
              >
                <span class="w-full p-float-label">
                  ...
                  />
                  <label class="w-full" for="occupationData.position"
                ...
                <span class="w-full p-float-label">
                  ...
                  />
                  <label class="w-full" for="occupationData.workYears"
                    >No. of years working
                    <span class="text-danger">*</span></label
                  >
                </span>
        ...
        <div>
          <h2 class="mt-10 form-subheading">Initial Investment Details</h2>
          ...
          <div class="grid grid-cols-1 gap-8 mt-10 md:grid-cols-2">
            <span class="w-full px-1">
              <label class="w-full" for="validId"
                >Valid ID <span class="text-danger">*</span></label
              >
              <FileUpload
                class="w-full"
                id="validId"
            ...
            <span class="w-full px-1">
              <label class="w-full" for="proofOfPayment"
                >Proof of Payment <span class="text-danger">*</span></label
              >
              <FileUpload
                class="w-full"
                id="proofOfPayment"
