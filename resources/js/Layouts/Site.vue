...
const items = ref([
  ...
  },
  {
    ...
    class: 'mlth-menu-item',
    command: () =>
      router.get(route(page.props.user ? 'invest.dashboard' : 'auth.login')),
  },
]);
  ...
  <main>
    ...
    >
      <div class="relative flex w-full">
        ...
        <div class="flex items-center gap-3 lg:mx-auto lg:justify-center">
          <p
      ...
      >
        <ul class="flex gap-8 font-bold">
          ...
          <li :class="{ active: $page.url.startsWith('/invest') }">
            <Link :href="route('site.investments.index')">Invest</Link>
          </li>
        </ul>
      </nav>
    </header>
